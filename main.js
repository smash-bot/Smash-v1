...
const { loftmenuCommand, handleLoftButton } = require('./commands/loft');
const { loftmenuCommand, handleLoftpayButton } = require('./commands/loftpay');
const { loftmenuCommand, handleLoftquetesButton } = require('./commands/loftquetes');
